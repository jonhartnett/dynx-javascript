...
mocha.describe('Dynx', () => {
    ...
    mocha.describe('lifetime', () => {
        ...
        mocha.it('can be made constant', () => {
            ...
            assert.isNotOk(dynx.isConstant);
            assert.isNotOk(dynx.isFinal);
            assert.isNotOk(dynx2.isConstant);
            assert.isOk(dynx2.isFinal);
            dynx.constant(3);
            assert.equal(dynx.value, 3);
            assert.equal(dynx2.value, 3);
            assert.isOk(dynx.isConstant);
            assert.isOk(dynx.isFinal);
            assert.isOk(dynx2.isConstant);
            assert.isOk(dynx2.isFinal);
        });
    });
});